...
$requiredFiles = @(
    ...
    "scripts/show-agent-pack-menu.ps1",
    "scripts/show-agent-pack-menu.linux.sh",
    "scripts/show-agent-pack-menu.macos.sh",
    "scripts/show-agent-pack-menu.shared.sh",
    ...
    "scripts/test-kilo-code-cli-models.macos.sh",
    "scripts/test-kilo-code-cli-models.linux.sh",
    "scripts/test-kilo-code-cli-models.ps1",
    "scripts/test-roo-code-cli-models.shared.sh",
    "scripts/test-roo-code-cli-models.macos.sh",
    "scripts/test-roo-code-cli-models.linux.sh",
