...
- OpenCode remains subject to non-generated-repository validation. Evaluate any future surface externally under the admission policy before adding implementation work.
