...
- Treat any previously removed integration as new work and require every promotion gate before adding scripts, catalog entries, or default-menu visibility.
