...
| `setup-agent-surface` | Plan, install, configure, or health-check a supported non-Continue surface through a surface-native adapter. Aider is the first implementation. | `approved-write` | yes | `scripts/setup-agent-surface.ps1` | `docs/aider-cli-model-testing.md` |
