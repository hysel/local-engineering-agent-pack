...
| Milestone 22: Unified Product UI And Task Composition | In progress | Tauri 2 and private typed IPC are selected. Disposable Windows npm/PyInstaller graphs passed, but Windows-reachable unmaintained Rust crates and the unrun native Tauri build keep runtime files out of the repository. |
