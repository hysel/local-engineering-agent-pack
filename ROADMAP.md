...
| Milestone 21: General-Purpose AI Assistant And Intent Routing | In progress | Repository-optional sessions, deterministic capability routing, a live-validated local text adapter, runtime provider discovery, engineering workflow route plans, and an optional bounded LLM suggestion layer are implemented; image-provider admission remains. |
