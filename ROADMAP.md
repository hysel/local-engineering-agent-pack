...
- Kilo Code has a dry-run-capable test harness and scaffolded install/configure adapter, but live task execution remains unresolved. Roo Code is retained only for historical compatibility because its upstream project is retired.
