...
- Keep per-script documentation available as appendix/reference material for advanced users, maintainers, and automation authors rather than presenting every script as a primary user choice.
